...
object KotlinToProto {
    fun mapBigDecimalToProtoDecimal(value: java.math.BigDecimal): org.somda.protosdc.proto.model.common.Decimal {
    ...
    fun map_org_somda_protosdc_biceps_model_RealTimeValueType(source: org.somda.protosdc.biceps.model.RealTimeValueType): org.somda.protosdc.proto.model.biceps.RealTimeValueTypeMsg {
        ...
        builder.addAllDecimal(source.decimal.map { mapBigDecimalToProtoDecimal(it) }.toList())
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_QualityIndicator(source: org.somda.protosdc.biceps.model.QualityIndicator): org.somda.protosdc.proto.model.biceps.QualityIndicatorMsg {
        ...
        builder.decimal = mapBigDecimalToProtoDecimal(source.decimal)
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_TimeFrame(source: org.somda.protosdc.biceps.model.TimeFrame): org.somda.protosdc.proto.model.biceps.TimeFrameMsg {
        ...
        source.startAttr?.let { field ->
            builder.startAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        source.endAttr?.let { field ->
            builder.endAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_MdibVersionGroup(source: org.somda.protosdc.biceps.model.MdibVersionGroup): org.somda.protosdc.proto.model.biceps.MdibVersionGroupMsg {
        ...
        source.mdibVersionAttr?.let { field ->
            builder.mdibVersionAttr = map_org_somda_protosdc_biceps_model_VersionCounter(field)
        }
        builder.sequenceIdAttr = source.sequenceIdAttr
        source.instanceIdAttr?.let { field ->
            builder.instanceIdAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt64(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ContainmentTreeInfo(source: org.somda.protosdc.biceps.model.ContainmentTreeInfo): org.somda.protosdc.proto.model.biceps.ContainmentTreeInfoMsg {
        ...
        source.handleRefAttr?.let { field ->
            builder.handleRefAttr = map_org_somda_protosdc_biceps_model_HandleRef(field)
        }
        source.parentHandleRefAttr?.let { field ->
            builder.parentHandleRefAttr = map_org_somda_protosdc_biceps_model_HandleRef(field)
        }
        source.entryTypeAttr?.let { field ->
            builder.entryTypeAttr = map_org_somda_protosdc_biceps_model_QualifiedName(field)
        }
        source.childrenCountAttr?.let { field ->
            builder.childrenCountAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToInt32Value(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractReport(source: org.somda.protosdc.biceps.model.AbstractReport): org.somda.protosdc.proto.model.biceps.AbstractReportMsg {
        ...
        source.extensionElement?.let { field ->
            builder.extensionElement = map_org_somda_protosdc_biceps_model_Extension(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractReportPart(source: org.somda.protosdc.biceps.model.AbstractReportPart): org.somda.protosdc.proto.model.biceps.AbstractReportPartMsg {
        ...
        source.sourceMds?.let { field ->
            builder.sourceMds = map_org_somda_protosdc_biceps_model_HandleRef(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_LocationDetail(source: org.somda.protosdc.biceps.model.LocationDetail): org.somda.protosdc.proto.model.biceps.LocationDetailMsg {
        ...
        source.poCAttr?.let { field ->
            builder.poCAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.roomAttr?.let { field ->
            builder.roomAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.bedAttr?.let { field ->
            builder.bedAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.facilityAttr?.let { field ->
            builder.facilityAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.buildingAttr?.let { field ->
            builder.buildingAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.floorAttr?.let { field ->
            builder.floorAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_VersionFrame(source: org.somda.protosdc.biceps.model.VersionFrame): org.somda.protosdc.proto.model.biceps.VersionFrameMsg {
        ...
        source.startAttr?.let { field ->
            builder.startAttr = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
        source.endAttr?.let { field ->
            builder.endAttr = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_LocalizedText(source: org.somda.protosdc.biceps.model.LocalizedText): org.somda.protosdc.proto.model.biceps.LocalizedTextMsg {
        ...
        source.refAttr?.let { field ->
            builder.refAttr = map_org_somda_protosdc_biceps_model_LocalizedTextRef(field)
        }
        source.langAttr?.let { field ->
            builder.langAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.versionAttr?.let { field ->
            builder.versionAttr = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
        source.textWidthAttr?.let { field ->
            builder.textWidthAttr = map_org_somda_protosdc_biceps_model_LocalizedTextWidth(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_RetrievabilityInfo(source: org.somda.protosdc.biceps.model.RetrievabilityInfo): org.somda.protosdc.proto.model.biceps.RetrievabilityInfoMsg {
        ...
        source.updatePeriodAttr?.let { field ->
            builder.updatePeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractState(source: org.somda.protosdc.biceps.model.AbstractState): org.somda.protosdc.proto.model.biceps.AbstractStateMsg {
        ...
        source.stateVersionAttr?.let { field ->
            builder.stateVersionAttr = map_org_somda_protosdc_biceps_model_VersionCounter(field)
        }
        builder.descriptorHandleAttr = map_org_somda_protosdc_biceps_model_HandleRef(source.descriptorHandleAttr)
        source.descriptorVersionAttr?.let { field ->
            builder.descriptorVersionAttr = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_Range(source: org.somda.protosdc.biceps.model.Range): org.somda.protosdc.proto.model.biceps.RangeMsg {
        ...
        source.lowerAttr?.let { field ->
            builder.lowerAttr = mapBigDecimalToProtoDecimal(field)
        }
        source.upperAttr?.let { field ->
            builder.upperAttr = mapBigDecimalToProtoDecimal(field)
        }
        source.stepWidthAttr?.let { field ->
            builder.stepWidthAttr = mapBigDecimalToProtoDecimal(field)
        }
        source.relativeAccuracyAttr?.let { field ->
            builder.relativeAccuracyAttr = mapBigDecimalToProtoDecimal(field)
        }
        source.absoluteAccuracyAttr?.let { field ->
            builder.absoluteAccuracyAttr = mapBigDecimalToProtoDecimal(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_BaseDemographics(source: org.somda.protosdc.biceps.model.BaseDemographics): org.somda.protosdc.proto.model.biceps.BaseDemographicsMsg {
        ...
        source.givenname?.let { field ->
            builder.givenname = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        builder.addAllMiddlename(source.middlename.map { it }.toList())
        source.familyname?.let { field ->
            builder.familyname = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.birthname?.let { field ->
            builder.birthname = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.title?.let { field ->
            builder.title = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_CodedValue_Translation(source: org.somda.protosdc.biceps.model.CodedValue.Translation): org.somda.protosdc.proto.model.biceps.CodedValueMsg.TranslationMsg {
        ...
        source.codingSystemAttr?.let { field ->
            builder.codingSystemAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        source.codingSystemVersionAttr?.let { field ->
            builder.codingSystemVersionAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_CodedValue(source: org.somda.protosdc.biceps.model.CodedValue): org.somda.protosdc.proto.model.biceps.CodedValueMsg {
        ...
        source.symbolicCodeNameAttr?.let { field ->
            builder.symbolicCodeNameAttr = map_org_somda_protosdc_biceps_model_SymbolicCodeName(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_GetStatesFromArchive(source: org.somda.protosdc.biceps.model.GetStatesFromArchive): org.somda.protosdc.proto.model.biceps.GetStatesFromArchiveMsg {
        ...
        builder.abstractGet = map_org_somda_protosdc_biceps_model_AbstractGet(source.abstractGet)
        source.stateRevisions?.let { field ->
            builder.stateRevisions = map_org_somda_protosdc_biceps_model_VersionFrame(field)
        }
        source.timeFrame?.let { field ->
            builder.timeFrame = map_org_somda_protosdc_biceps_model_TimeFrame(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_SystemErrorReport_ReportPart(source: org.somda.protosdc.biceps.model.SystemErrorReport.ReportPart): org.somda.protosdc.proto.model.biceps.SystemErrorReportMsg.ReportPartMsg {
        ...
        source.errorInfo?.let { field ->
            builder.errorInfo = map_org_somda_protosdc_biceps_model_LocalizedText(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_GetLocalizedText(source: org.somda.protosdc.biceps.model.GetLocalizedText): org.somda.protosdc.proto.model.biceps.GetLocalizedTextMsg {
        ...
        source.version?.let { field ->
            builder.version = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_GetDescriptorsFromArchive(source: org.somda.protosdc.biceps.model.GetDescriptorsFromArchive): org.somda.protosdc.proto.model.biceps.GetDescriptorsFromArchiveMsg {
        ...
        builder.abstractGet = map_org_somda_protosdc_biceps_model_AbstractGet(source.abstractGet)
        source.descriptorRevisions?.let { field ->
            builder.descriptorRevisions = map_org_somda_protosdc_biceps_model_VersionFrame(field)
        }
        source.timeFrame?.let { field ->
            builder.timeFrame = map_org_somda_protosdc_biceps_model_TimeFrame(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_SetValue(source: org.somda.protosdc.biceps.model.SetValue): org.somda.protosdc.proto.model.biceps.SetValueMsg {
        ...
        builder.abstractSet = map_org_somda_protosdc_biceps_model_AbstractSet(source.abstractSet)
        builder.requestedNumericValue = mapBigDecimalToProtoDecimal(source.requestedNumericValue)
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_GetContextStatesByFilter(source: org.somda.protosdc.biceps.model.GetContextStatesByFilter): org.somda.protosdc.proto.model.biceps.GetContextStatesByFilterMsg {
        ...
        source.contextTypeAttr?.let { field ->
            builder.contextTypeAttr = map_org_somda_protosdc_biceps_model_QualifiedName(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_InvocationInfo(source: org.somda.protosdc.biceps.model.InvocationInfo): org.somda.protosdc.proto.model.biceps.InvocationInfoMsg {
        ...
        source.invocationError?.let { field ->
            builder.invocationError = map_org_somda_protosdc_biceps_model_InvocationError(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_ContainmentTreeEntry(source: org.somda.protosdc.biceps.model.ContainmentTreeEntry): org.somda.protosdc.proto.model.biceps.ContainmentTreeEntryMsg {
        ...
        source.type?.let { field ->
            builder.type = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractMetricValue_MetricQuality(source: org.somda.protosdc.biceps.model.AbstractMetricValue.MetricQuality): org.somda.protosdc.proto.model.biceps.AbstractMetricValueMsg.MetricQualityMsg {
        ...
        source.modeAttr?.let { field ->
            builder.modeAttr = map_org_somda_protosdc_biceps_model_GenerationMode(field)
        }
        source.qiAttr?.let { field ->
            builder.qiAttr = map_org_somda_protosdc_biceps_model_QualityIndicator(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractMetricValue(source: org.somda.protosdc.biceps.model.AbstractMetricValue): org.somda.protosdc.proto.model.biceps.AbstractMetricValueMsg {
        ...
        source.startTimeAttr?.let { field ->
            builder.startTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        source.stopTimeAttr?.let { field ->
            builder.stopTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        source.determinationTimeAttr?.let { field ->
            builder.determinationTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_StringMetricValue(source: org.somda.protosdc.biceps.model.StringMetricValue): org.somda.protosdc.proto.model.biceps.StringMetricValueMsg {
        ...
        source.valueAttr?.let { field ->
            builder.valueAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_NumericMetricValue(source: org.somda.protosdc.biceps.model.NumericMetricValue): org.somda.protosdc.proto.model.biceps.NumericMetricValueMsg {
        ...
        builder.abstractMetricValue = map_org_somda_protosdc_biceps_model_AbstractMetricValue(source.abstractMetricValue)
        source.valueAttr?.let { field ->
            builder.valueAttr = mapBigDecimalToProtoDecimal(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_PhysicalConnectorInfo(source: org.somda.protosdc.biceps.model.PhysicalConnectorInfo): org.somda.protosdc.proto.model.biceps.PhysicalConnectorInfoMsg {
        ...
        source.numberAttr?.let { field ->
            builder.numberAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToInt32Value(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_InstanceIdentifier(source: org.somda.protosdc.biceps.model.InstanceIdentifier): org.somda.protosdc.proto.model.biceps.InstanceIdentifierMsg {
        ...
        source.rootAttr?.let { field ->
            builder.rootAttr = map_org_somda_protosdc_biceps_model_InstanceIdentifier_RootAttr(field)
        }
        source.extensionAttr?.let { field ->
            builder.extensionAttr = map_org_somda_protosdc_biceps_model_InstanceIdentifier_ExtensionAttr(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_AlertConditionState(source: org.somda.protosdc.biceps.model.AlertConditionState): org.somda.protosdc.proto.model.biceps.AlertConditionStateMsg {
        ...
        source.actualConditionGenerationDelayAttr?.let { field ->
            builder.actualConditionGenerationDelayAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.actualPriorityAttr?.let { field ->
            builder.actualPriorityAttr = map_org_somda_protosdc_biceps_model_AlertConditionPriority(field)
        }
        source.rankAttr?.let { field ->
            builder.rankAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToInt32Value(field)
        }
        source.presenceAttr?.let { field ->
            builder.presenceAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToBoolValue(field)
        }
        source.determinationTimeAttr?.let { field ->
            builder.determinationTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_AlertSystemState(source: org.somda.protosdc.biceps.model.AlertSystemState): org.somda.protosdc.proto.model.biceps.AlertSystemStateMsg {
        ...
        source.lastSelfCheckAttr?.let { field ->
            builder.lastSelfCheckAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        source.selfCheckCountAttr?.let { field ->
            builder.selfCheckCountAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToInt64Value(field)
        }
        source.presentPhysiologicalAlarmConditionsAttr?.let { field ->
            builder.presentPhysiologicalAlarmConditionsAttr = map_org_somda_protosdc_biceps_model_AlertConditionReference(field)
        }
        source.presentTechnicalAlarmConditionsAttr?.let { field ->
            builder.presentTechnicalAlarmConditionsAttr = map_org_somda_protosdc_biceps_model_AlertConditionReference(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_CauseInfo(source: org.somda.protosdc.biceps.model.CauseInfo): org.somda.protosdc.proto.model.biceps.CauseInfoMsg {
        ...
        source.remedyInfo?.let { field ->
            builder.remedyInfo = map_org_somda_protosdc_biceps_model_RemedyInfo(field)
        }
        builder.addAllDescription(source.description.map { map_org_somda_protosdc_biceps_model_LocalizedText(it) }.toList())
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractMultiState(source: org.somda.protosdc.biceps.model.AbstractMultiState): org.somda.protosdc.proto.model.biceps.AbstractMultiStateMsg {
        ...
        builder.abstractState = map_org_somda_protosdc_biceps_model_AbstractState(source.abstractState)
        source.category?.let { field ->
            builder.category = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_Measurement(source: org.somda.protosdc.biceps.model.Measurement): org.somda.protosdc.proto.model.biceps.MeasurementMsg {
        ...
        builder.measuredValueAttr = mapBigDecimalToProtoDecimal(source.measuredValueAttr)
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractDescriptor(source: org.somda.protosdc.biceps.model.AbstractDescriptor): org.somda.protosdc.proto.model.biceps.AbstractDescriptorMsg {
        ...
        builder.handleAttr = map_org_somda_protosdc_biceps_model_Handle(source.handleAttr)
        source.descriptorVersionAttr?.let { field ->
            builder.descriptorVersionAttr = map_org_somda_protosdc_biceps_model_VersionCounter(field)
        }
        source.safetyClassificationAttr?.let { field ->
            builder.safetyClassificationAttr = map_org_somda_protosdc_biceps_model_SafetyClassification(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_SetStringOperationState(source: org.somda.protosdc.biceps.model.SetStringOperationState): org.somda.protosdc.proto.model.biceps.SetStringOperationStateMsg {
        ...
        builder.abstractOperationState = map_org_somda_protosdc_biceps_model_AbstractOperationState(source.abstractOperationState)
        source.allowedValues?.let { field ->
            builder.allowedValues = map_org_somda_protosdc_biceps_model_SetStringOperationState_AllowedValues(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_PatientDemographicsCoreData_DateOfBirth(source: org.somda.protosdc.biceps.model.PatientDemographicsCoreData.DateOfBirth): org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataMsg.DateOfBirthMsg {
        when (source) {
            org.somda.protosdc.biceps.model.PatientDemographicsCoreData.DateOfBirth.valueLocalDateTime -> org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataMsg.DateOfBirthMsg.newBuilder().setDateTime(org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapLocalDateTime(source.value)).build()
            org.somda.protosdc.biceps.model.PatientDemographicsCoreData.DateOfBirth.valueLocalDate -> org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataMsg.DateOfBirthMsg.newBuilder().setDate(org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapLocalDate(source.value)).build()
            org.somda.protosdc.biceps.model.PatientDemographicsCoreData.DateOfBirth.valueYearMonth -> org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataMsg.DateOfBirthMsg.newBuilder().setGYearMonth(org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapYearMonth(source.value)).build()
            org.somda.protosdc.biceps.model.PatientDemographicsCoreData.DateOfBirth.valueYear -> org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataMsg.DateOfBirthMsg.newBuilder().setGYear(org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapYear(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_PatientDemographicsCoreData(source: org.somda.protosdc.biceps.model.PatientDemographicsCoreData): org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataMsg {
        ...
        source.sex?.let { field ->
            builder.sex = map_org_somda_protosdc_biceps_model_Sex(field)
        }
        source.patientType?.let { field ->
            builder.patientType = map_org_somda_protosdc_biceps_model_PatientType(field)
        }
        source.dateOfBirth?.let { field ->
            builder.dateOfBirth = map_org_somda_protosdc_biceps_model_PatientDemographicsCoreData_DateOfBirth(field)
        }
        source.height?.let { field ->
            builder.height = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.weight?.let { field ->
            builder.weight = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.race?.let { field ->
            builder.race = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractMetricState(source: org.somda.protosdc.biceps.model.AbstractMetricState): org.somda.protosdc.proto.model.biceps.AbstractMetricStateMsg {
        ...
        source.physicalConnector?.let { field ->
            builder.physicalConnector = map_org_somda_protosdc_biceps_model_PhysicalConnectorInfo(field)
        }
        source.activationStateAttr?.let { field ->
            builder.activationStateAttr = map_org_somda_protosdc_biceps_model_ComponentActivation(field)
        }
        source.activeDeterminationPeriodAttr?.let { field ->
            builder.activeDeterminationPeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.lifeTimePeriodAttr?.let { field ->
            builder.lifeTimePeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_ClinicalInfo_RelatedMeasurement_ReferenceRange(source: org.somda.protosdc.biceps.model.ClinicalInfo.RelatedMeasurement.ReferenceRange): org.somda.protosdc.proto.model.biceps.ClinicalInfoMsg.RelatedMeasurementMsg.ReferenceRangeMsg {
        ...
        source.meaning?.let { field ->
            builder.meaning = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ClinicalInfo_RelatedMeasurement(source: org.somda.protosdc.biceps.model.ClinicalInfo.RelatedMeasurement): org.somda.protosdc.proto.model.biceps.ClinicalInfoMsg.RelatedMeasurementMsg {
        ...
        source.validityAttr?.let { field ->
            builder.validityAttr = map_org_somda_protosdc_biceps_model_MeasurementValidity(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ClinicalInfo(source: org.somda.protosdc.biceps.model.ClinicalInfo): org.somda.protosdc.proto.model.biceps.ClinicalInfoMsg {
        ...
        source.code?.let { field ->
            builder.code = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
        source.criticality?.let { field ->
            builder.criticality = map_org_somda_protosdc_biceps_model_ClinicalInfo_Criticality(field)
        }
        builder.addAllDescription(source.description.map { map_org_somda_protosdc_biceps_model_LocalizedText(it) }.toList())
    ...
    fun map_org_somda_protosdc_biceps_model_SampleArrayValue(source: org.somda.protosdc.biceps.model.SampleArrayValue): org.somda.protosdc.proto.model.biceps.SampleArrayValueMsg {
        ...
        source.samplesAttr?.let { field ->
            builder.samplesAttr = map_org_somda_protosdc_biceps_model_RealTimeValueType(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_LimitAlertConditionState(source: org.somda.protosdc.biceps.model.LimitAlertConditionState): org.somda.protosdc.proto.model.biceps.LimitAlertConditionStateMsg {
        ...
        source.autoLimitActivationStateAttr?.let { field ->
            builder.autoLimitActivationStateAttr = map_org_somda_protosdc_biceps_model_AlertActivation(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_RealTimeSampleArrayMetricState(source: org.somda.protosdc.biceps.model.RealTimeSampleArrayMetricState): org.somda.protosdc.proto.model.biceps.RealTimeSampleArrayMetricStateMsg {
        ...
        source.metricValue?.let { field ->
            builder.metricValue = map_org_somda_protosdc_biceps_model_SampleArrayValue(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_CalibrationInfo(source: org.somda.protosdc.biceps.model.CalibrationInfo): org.somda.protosdc.proto.model.biceps.CalibrationInfoMsg {
        ...
        source.componentCalibrationStateAttr?.let { field ->
            builder.componentCalibrationStateAttr = map_org_somda_protosdc_biceps_model_CalibrationState(field)
        }
        source.typeAttr?.let { field ->
            builder.typeAttr = map_org_somda_protosdc_biceps_model_CalibrationType(field)
        }
        source.timeAttr?.let { field ->
            builder.timeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_AlertSignalState(source: org.somda.protosdc.biceps.model.AlertSignalState): org.somda.protosdc.proto.model.biceps.AlertSignalStateMsg {
        ...
        builder.abstractAlertState = map_org_somda_protosdc_biceps_model_AbstractAlertState(source.abstractAlertState)
        source.actualSignalGenerationDelayAttr?.let { field ->
            builder.actualSignalGenerationDelayAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.presenceAttr?.let { field ->
            builder.presenceAttr = map_org_somda_protosdc_biceps_model_AlertSignalPresence(field)
        }
        source.locationAttr?.let { field ->
            builder.locationAttr = map_org_somda_protosdc_biceps_model_AlertSignalPrimaryLocation(field)
        }
        source.slotAttr?.let { field ->
            builder.slotAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt32(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractOperationDescriptor(source: org.somda.protosdc.biceps.model.AbstractOperationDescriptor): org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorMsg {
        ...
        source.maxTimeToFinishAttr?.let { field ->
            builder.maxTimeToFinishAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.invocationEffectiveTimeoutAttr?.let { field ->
            builder.invocationEffectiveTimeoutAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.retriggerableAttr?.let { field ->
            builder.retriggerableAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToBoolValue(field)
        }
        source.accessLevelAttr?.let { field ->
            builder.accessLevelAttr = map_org_somda_protosdc_biceps_model_AbstractOperationDescriptor_AccessLevelAttr(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_NumericMetricState(source: org.somda.protosdc.biceps.model.NumericMetricState): org.somda.protosdc.proto.model.biceps.NumericMetricStateMsg {
        ...
        builder.abstractMetricState = map_org_somda_protosdc_biceps_model_AbstractMetricState(source.abstractMetricState)
        source.metricValue?.let { field ->
            builder.metricValue = map_org_somda_protosdc_biceps_model_NumericMetricValue(field)
        }
        builder.addAllPhysiologicalRange(source.physiologicalRange.map { map_org_somda_protosdc_biceps_model_Range(it) }.toList())
        source.activeAveragingPeriodAttr?.let { field ->
            builder.activeAveragingPeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AlertConditionDescriptor(source: org.somda.protosdc.biceps.model.AlertConditionDescriptor): org.somda.protosdc.proto.model.biceps.AlertConditionDescriptorMsg {
        ...
        source.defaultConditionGenerationDelayAttr?.let { field ->
            builder.defaultConditionGenerationDelayAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.canEscalateAttr?.let { field ->
            builder.canEscalateAttr = map_org_somda_protosdc_biceps_model_AlertConditionDescriptor_CanEscalateAttr(field)
        }
        source.canDeescalateAttr?.let { field ->
            builder.canDeescalateAttr = map_org_somda_protosdc_biceps_model_AlertConditionDescriptor_CanDeescalateAttr(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AlertSignalDescriptor(source: org.somda.protosdc.biceps.model.AlertSignalDescriptor): org.somda.protosdc.proto.model.biceps.AlertSignalDescriptorMsg {
        ...
        builder.abstractAlertDescriptor = map_org_somda_protosdc_biceps_model_AbstractAlertDescriptor(source.abstractAlertDescriptor)
        source.conditionSignaledAttr?.let { field ->
            builder.conditionSignaledAttr = map_org_somda_protosdc_biceps_model_HandleRef(field)
        }
        builder.manifestationAttr = map_org_somda_protosdc_biceps_model_AlertSignalManifestation(source.manifestationAttr)
        builder.latchingAttr = source.latchingAttr
        source.defaultSignalGenerationDelayAttr?.let { field ->
            builder.defaultSignalGenerationDelayAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.minSignalGenerationDelayAttr?.let { field ->
            builder.minSignalGenerationDelayAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.maxSignalGenerationDelayAttr?.let { field ->
            builder.maxSignalGenerationDelayAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.signalDelegationSupportedAttr?.let { field ->
            builder.signalDelegationSupportedAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToBoolValue(field)
        }
        source.acknowledgementSupportedAttr?.let { field ->
            builder.acknowledgementSupportedAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToBoolValue(field)
        }
        source.acknowledgeTimeoutAttr?.let { field ->
            builder.acknowledgeTimeoutAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_StringMetricState(source: org.somda.protosdc.biceps.model.StringMetricState): org.somda.protosdc.proto.model.biceps.StringMetricStateMsg {
        ...
        builder.abstractMetricState = map_org_somda_protosdc_biceps_model_AbstractMetricState(source.abstractMetricState)
        source.metricValue?.let { field ->
            builder.metricValue = map_org_somda_protosdc_biceps_model_StringMetricValue(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ObservedValueStream_Value(source: org.somda.protosdc.biceps.model.ObservedValueStream.Value): org.somda.protosdc.proto.model.biceps.ObservedValueStreamMsg.ValueMsg {
        ...
        source.value?.let { field ->
            builder.value = map_org_somda_protosdc_biceps_model_SampleArrayValue(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_LimitAlertConditionDescriptor(source: org.somda.protosdc.biceps.model.LimitAlertConditionDescriptor): org.somda.protosdc.proto.model.biceps.LimitAlertConditionDescriptorMsg {
        ...
        source.autoLimitSupportedAttr?.let { field ->
            builder.autoLimitSupportedAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToBoolValue(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractDeviceComponentState(source: org.somda.protosdc.biceps.model.AbstractDeviceComponentState): org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateMsg {
        ...
        builder.abstractState = map_org_somda_protosdc_biceps_model_AbstractState(source.abstractState)
        source.calibrationInfo?.let { field ->
            builder.calibrationInfo = map_org_somda_protosdc_biceps_model_CalibrationInfo(field)
        }
        source.nextCalibration?.let { field ->
            builder.nextCalibration = map_org_somda_protosdc_biceps_model_CalibrationInfo(field)
        }
        source.physicalConnector?.let { field ->
            builder.physicalConnector = map_org_somda_protosdc_biceps_model_PhysicalConnectorInfo(field)
        }
        ...
        source.operatingHoursAttr?.let { field ->
            builder.operatingHoursAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt32(field)
        }
        source.operatingCyclesAttr?.let { field ->
            builder.operatingCyclesAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToInt32Value(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_SetStringOperationDescriptor(source: org.somda.protosdc.biceps.model.SetStringOperationDescriptor): org.somda.protosdc.proto.model.biceps.SetStringOperationDescriptorMsg {
        ...
        source.maxLengthAttr?.let { field ->
            builder.maxLengthAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt64(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ClockState(source: org.somda.protosdc.biceps.model.ClockState): org.somda.protosdc.proto.model.biceps.ClockStateMsg {
        ...
        builder.abstractDeviceComponentState = map_org_somda_protosdc_biceps_model_AbstractDeviceComponentState(source.abstractDeviceComponentState)
        source.activeSyncProtocol?.let { field ->
            builder.activeSyncProtocol = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
        builder.addAllReferenceSource(source.referenceSource.map { it }.toList())
        source.dateAndTimeAttr?.let { field ->
            builder.dateAndTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        builder.remoteSyncAttr = source.remoteSyncAttr
        source.accuracyAttr?.let { field ->
            builder.accuracyAttr = mapBigDecimalToProtoDecimal(field)
        }
        source.lastSetAttr?.let { field ->
            builder.lastSetAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        source.timeZoneAttr?.let { field ->
            builder.timeZoneAttr = map_org_somda_protosdc_biceps_model_TimeZone(field)
        }
        source.criticalUseAttr?.let { field ->
            builder.criticalUseAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToBoolValue(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_VmdState(source: org.somda.protosdc.biceps.model.VmdState): org.somda.protosdc.proto.model.biceps.VmdStateMsg {
        ...
        source.operatingJurisdiction?.let { field ->
            builder.operatingJurisdiction = map_org_somda_protosdc_biceps_model_OperatingJurisdiction(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_BatteryState(source: org.somda.protosdc.biceps.model.BatteryState): org.somda.protosdc.proto.model.biceps.BatteryStateMsg {
        ...
        builder.abstractDeviceComponentState = map_org_somda_protosdc_biceps_model_AbstractDeviceComponentState(source.abstractDeviceComponentState)
        source.capacityRemaining?.let { field ->
            builder.capacityRemaining = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.voltage?.let { field ->
            builder.voltage = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.current?.let { field ->
            builder.current = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.temperature?.let { field ->
            builder.temperature = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.remainingBatteryTime?.let { field ->
            builder.remainingBatteryTime = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.chargeStatusAttr?.let { field ->
            builder.chargeStatusAttr = map_org_somda_protosdc_biceps_model_BatteryState_ChargeStatusAttr(field)
        }
        source.chargeCyclesAttr?.let { field ->
            builder.chargeCyclesAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt32(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_MdsState(source: org.somda.protosdc.biceps.model.MdsState): org.somda.protosdc.proto.model.biceps.MdsStateMsg {
        ...
        source.operatingModeAttr?.let { field ->
            builder.operatingModeAttr = map_org_somda_protosdc_biceps_model_MdsOperatingMode(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ScoState_OperationGroup(source: org.somda.protosdc.biceps.model.ScoState.OperationGroup): org.somda.protosdc.proto.model.biceps.ScoStateMsg.OperationGroupMsg {
        ...
        builder.type = map_org_somda_protosdc_biceps_model_CodedValue(source.type)
        source.operatingModeAttr?.let { field ->
            builder.operatingModeAttr = map_org_somda_protosdc_biceps_model_OperatingMode(field)
        }
        source.operationsAttr?.let { field ->
            builder.operationsAttr = map_org_somda_protosdc_biceps_model_OperationRef(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ScoState(source: org.somda.protosdc.biceps.model.ScoState): org.somda.protosdc.proto.model.biceps.ScoStateMsg {
        ...
        source.invocationRequestedAttr?.let { field ->
            builder.invocationRequestedAttr = map_org_somda_protosdc_biceps_model_OperationRef(field)
        }
        source.invocationRequiredAttr?.let { field ->
            builder.invocationRequiredAttr = map_org_somda_protosdc_biceps_model_OperationRef(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_LocalizedTextContentOneOf(source: org.somda.protosdc.biceps.model.LocalizedTextContentOneOf): org.somda.protosdc.proto.model.biceps.LocalizedTextContentOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.LocalizedTextContentOneOf.valueLocalizedTextContent -> org.somda.protosdc.proto.model.biceps.LocalizedTextContentOneOfMsg.newBuilder().setLocalizedTextContent(map_org_somda_protosdc_biceps_model_LocalizedTextContent(source.value)).build()
            org.somda.protosdc.biceps.model.LocalizedTextContentOneOf.valueLocalizedText -> org.somda.protosdc.proto.model.biceps.LocalizedTextContentOneOfMsg.newBuilder().setLocalizedText(map_org_somda_protosdc_biceps_model_LocalizedText(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractOperationStateOneOf(source: org.somda.protosdc.biceps.model.AbstractOperationStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueAbstractOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setAbstractOperationState(map_org_somda_protosdc_biceps_model_AbstractOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueActivateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setActivateOperationState(map_org_somda_protosdc_biceps_model_ActivateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueSetAlertStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setSetAlertStateOperationState(map_org_somda_protosdc_biceps_model_SetAlertStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueSetComponentStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setSetComponentStateOperationState(map_org_somda_protosdc_biceps_model_SetComponentStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueSetContextStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setSetContextStateOperationState(map_org_somda_protosdc_biceps_model_SetContextStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueSetMetricStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setSetMetricStateOperationState(map_org_somda_protosdc_biceps_model_SetMetricStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueSetStringOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setSetStringOperationState(map_org_somda_protosdc_biceps_model_SetStringOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationStateOneOf.valueSetValueOperationState -> org.somda.protosdc.proto.model.biceps.AbstractOperationStateOneOfMsg.newBuilder().setSetValueOperationState(map_org_somda_protosdc_biceps_model_SetValueOperationState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractMetricValueOneOf(source: org.somda.protosdc.biceps.model.AbstractMetricValueOneOf): org.somda.protosdc.proto.model.biceps.AbstractMetricValueOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractMetricValueOneOf.valueAbstractMetricValue -> org.somda.protosdc.proto.model.biceps.AbstractMetricValueOneOfMsg.newBuilder().setAbstractMetricValue(map_org_somda_protosdc_biceps_model_AbstractMetricValue(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricValueOneOf.valueNumericMetricValue -> org.somda.protosdc.proto.model.biceps.AbstractMetricValueOneOfMsg.newBuilder().setNumericMetricValue(map_org_somda_protosdc_biceps_model_NumericMetricValue(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricValueOneOf.valueSampleArrayValue -> org.somda.protosdc.proto.model.biceps.AbstractMetricValueOneOfMsg.newBuilder().setSampleArrayValue(map_org_somda_protosdc_biceps_model_SampleArrayValue(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricValueOneOf.valueStringMetricValue -> org.somda.protosdc.proto.model.biceps.AbstractMetricValueOneOfMsg.newBuilder().setStringMetricValue(map_org_somda_protosdc_biceps_model_StringMetricValue(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractAlertStateOneOf(source: org.somda.protosdc.biceps.model.AbstractAlertStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractAlertStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractAlertStateOneOf.valueAbstractAlertState -> org.somda.protosdc.proto.model.biceps.AbstractAlertStateOneOfMsg.newBuilder().setAbstractAlertState(map_org_somda_protosdc_biceps_model_AbstractAlertState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertStateOneOf.valueAlertConditionState -> org.somda.protosdc.proto.model.biceps.AbstractAlertStateOneOfMsg.newBuilder().setAlertConditionState(map_org_somda_protosdc_biceps_model_AlertConditionState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertStateOneOf.valueAlertSignalState -> org.somda.protosdc.proto.model.biceps.AbstractAlertStateOneOfMsg.newBuilder().setAlertSignalState(map_org_somda_protosdc_biceps_model_AlertSignalState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertStateOneOf.valueAlertSystemState -> org.somda.protosdc.proto.model.biceps.AbstractAlertStateOneOfMsg.newBuilder().setAlertSystemState(map_org_somda_protosdc_biceps_model_AlertSystemState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertStateOneOf.valueLimitAlertConditionState -> org.somda.protosdc.proto.model.biceps.AbstractAlertStateOneOfMsg.newBuilder().setLimitAlertConditionState(map_org_somda_protosdc_biceps_model_LimitAlertConditionState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractSetResponseOneOf(source: org.somda.protosdc.biceps.model.AbstractSetResponseOneOf): org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueAbstractSetResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setAbstractSetResponse(map_org_somda_protosdc_biceps_model_AbstractSetResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueActivateResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setActivateResponse(map_org_somda_protosdc_biceps_model_ActivateResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueSetAlertStateResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setSetAlertStateResponse(map_org_somda_protosdc_biceps_model_SetAlertStateResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueSetComponentStateResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setSetComponentStateResponse(map_org_somda_protosdc_biceps_model_SetComponentStateResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueSetContextStateResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setSetContextStateResponse(map_org_somda_protosdc_biceps_model_SetContextStateResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueSetMetricStateResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setSetMetricStateResponse(map_org_somda_protosdc_biceps_model_SetMetricStateResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueSetStringResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setSetStringResponse(map_org_somda_protosdc_biceps_model_SetStringResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetResponseOneOf.valueSetValueResponse -> org.somda.protosdc.proto.model.biceps.AbstractSetResponseOneOfMsg.newBuilder().setSetValueResponse(map_org_somda_protosdc_biceps_model_SetValueResponse(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(source: org.somda.protosdc.biceps.model.InstanceIdentifierOneOf): org.somda.protosdc.proto.model.biceps.InstanceIdentifierOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.InstanceIdentifierOneOf.valueInstanceIdentifier -> org.somda.protosdc.proto.model.biceps.InstanceIdentifierOneOfMsg.newBuilder().setInstanceIdentifier(map_org_somda_protosdc_biceps_model_InstanceIdentifier(source.value)).build()
            org.somda.protosdc.biceps.model.InstanceIdentifierOneOf.valueOperatingJurisdiction -> org.somda.protosdc.proto.model.biceps.InstanceIdentifierOneOfMsg.newBuilder().setOperatingJurisdiction(map_org_somda_protosdc_biceps_model_OperatingJurisdiction(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AlertConditionStateOneOf(source: org.somda.protosdc.biceps.model.AlertConditionStateOneOf): org.somda.protosdc.proto.model.biceps.AlertConditionStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AlertConditionStateOneOf.valueAlertConditionState -> org.somda.protosdc.proto.model.biceps.AlertConditionStateOneOfMsg.newBuilder().setAlertConditionState(map_org_somda_protosdc_biceps_model_AlertConditionState(source.value)).build()
            org.somda.protosdc.biceps.model.AlertConditionStateOneOf.valueLimitAlertConditionState -> org.somda.protosdc.proto.model.biceps.AlertConditionStateOneOfMsg.newBuilder().setLimitAlertConditionState(map_org_somda_protosdc_biceps_model_LimitAlertConditionState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractMetricStateOneOf(source: org.somda.protosdc.biceps.model.AbstractMetricStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractMetricStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractMetricStateOneOf.valueAbstractMetricState -> org.somda.protosdc.proto.model.biceps.AbstractMetricStateOneOfMsg.newBuilder().setAbstractMetricState(map_org_somda_protosdc_biceps_model_AbstractMetricState(source.value)).build()
            ...
            org.somda.protosdc.biceps.model.AbstractMetricStateOneOf.valueEnumStringMetricState -> org.somda.protosdc.proto.model.biceps.AbstractMetricStateOneOfMsg.newBuilder().setEnumStringMetricState(map_org_somda_protosdc_biceps_model_EnumStringMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricStateOneOf.valueNumericMetricState -> org.somda.protosdc.proto.model.biceps.AbstractMetricStateOneOfMsg.newBuilder().setNumericMetricState(map_org_somda_protosdc_biceps_model_NumericMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricStateOneOf.valueRealTimeSampleArrayMetricState -> org.somda.protosdc.proto.model.biceps.AbstractMetricStateOneOfMsg.newBuilder().setRealTimeSampleArrayMetricState(map_org_somda_protosdc_biceps_model_RealTimeSampleArrayMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricStateOneOf.valueStringMetricState -> org.somda.protosdc.proto.model.biceps.AbstractMetricStateOneOfMsg.newBuilder().setStringMetricState(map_org_somda_protosdc_biceps_model_StringMetricState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractContextDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valueAbstractContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setAbstractContextDescriptor(map_org_somda_protosdc_biceps_model_AbstractContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valueEnsembleContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setEnsembleContextDescriptor(map_org_somda_protosdc_biceps_model_EnsembleContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valueLocationContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setLocationContextDescriptor(map_org_somda_protosdc_biceps_model_LocationContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valueMeansContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setMeansContextDescriptor(map_org_somda_protosdc_biceps_model_MeansContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valueOperatorContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setOperatorContextDescriptor(map_org_somda_protosdc_biceps_model_OperatorContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valuePatientContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setPatientContextDescriptor(map_org_somda_protosdc_biceps_model_PatientContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextDescriptorOneOf.valueWorkflowContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractContextDescriptorOneOfMsg.newBuilder().setWorkflowContextDescriptor(map_org_somda_protosdc_biceps_model_WorkflowContextDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AlertConditionDescriptorOneOf(source: org.somda.protosdc.biceps.model.AlertConditionDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AlertConditionDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AlertConditionDescriptorOneOf.valueAlertConditionDescriptor -> org.somda.protosdc.proto.model.biceps.AlertConditionDescriptorOneOfMsg.newBuilder().setAlertConditionDescriptor(map_org_somda_protosdc_biceps_model_AlertConditionDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AlertConditionDescriptorOneOf.valueLimitAlertConditionDescriptor -> org.somda.protosdc.proto.model.biceps.AlertConditionDescriptorOneOfMsg.newBuilder().setLimitAlertConditionDescriptor(map_org_somda_protosdc_biceps_model_LimitAlertConditionDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractDeviceComponentStateOneOf(source: org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueAbstractDeviceComponentState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setAbstractDeviceComponentState(map_org_somda_protosdc_biceps_model_AbstractDeviceComponentState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueAbstractComplexDeviceComponentState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setAbstractComplexDeviceComponentState(map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueBatteryState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setBatteryState(map_org_somda_protosdc_biceps_model_BatteryState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueChannelState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setChannelState(map_org_somda_protosdc_biceps_model_ChannelState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueClockState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setClockState(map_org_somda_protosdc_biceps_model_ClockState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueMdsState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setMdsState(map_org_somda_protosdc_biceps_model_MdsState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueScoState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setScoState(map_org_somda_protosdc_biceps_model_ScoState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueSystemContextState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setSystemContextState(map_org_somda_protosdc_biceps_model_SystemContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentStateOneOf.valueVmdState -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentStateOneOfMsg.newBuilder().setVmdState(map_org_somda_protosdc_biceps_model_VmdState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractOperationDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueAbstractOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setAbstractOperationDescriptor(map_org_somda_protosdc_biceps_model_AbstractOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueAbstractSetStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setAbstractSetStateOperationDescriptor(map_org_somda_protosdc_biceps_model_AbstractSetStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueActivateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setActivateOperationDescriptor(map_org_somda_protosdc_biceps_model_ActivateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueSetAlertStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setSetAlertStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetAlertStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueSetComponentStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setSetComponentStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetComponentStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueSetContextStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setSetContextStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetContextStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueSetMetricStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setSetMetricStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetMetricStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueSetStringOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setSetStringOperationDescriptor(map_org_somda_protosdc_biceps_model_SetStringOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationDescriptorOneOf.valueSetValueOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractOperationDescriptorOneOfMsg.newBuilder().setSetValueOperationDescriptor(map_org_somda_protosdc_biceps_model_SetValueOperationDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_StringMetricStateOneOf(source: org.somda.protosdc.biceps.model.StringMetricStateOneOf): org.somda.protosdc.proto.model.biceps.StringMetricStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.StringMetricStateOneOf.valueStringMetricState -> org.somda.protosdc.proto.model.biceps.StringMetricStateOneOfMsg.newBuilder().setStringMetricState(map_org_somda_protosdc_biceps_model_StringMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.StringMetricStateOneOf.valueEnumStringMetricState -> org.somda.protosdc.proto.model.biceps.StringMetricStateOneOfMsg.newBuilder().setEnumStringMetricState(map_org_somda_protosdc_biceps_model_EnumStringMetricState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractSetStateOperationDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf.valueAbstractSetStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg.newBuilder().setAbstractSetStateOperationDescriptor(map_org_somda_protosdc_biceps_model_AbstractSetStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf.valueActivateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg.newBuilder().setActivateOperationDescriptor(map_org_somda_protosdc_biceps_model_ActivateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf.valueSetAlertStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg.newBuilder().setSetAlertStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetAlertStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf.valueSetComponentStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg.newBuilder().setSetComponentStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetComponentStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf.valueSetContextStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg.newBuilder().setSetContextStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetContextStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetStateOperationDescriptorOneOf.valueSetMetricStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractSetStateOperationDescriptorOneOfMsg.newBuilder().setSetMetricStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetMetricStateOperationDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentStateOneOf(source: org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentStateOneOf.valueAbstractComplexDeviceComponentState -> org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentStateOneOfMsg.newBuilder().setAbstractComplexDeviceComponentState(map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentStateOneOf.valueMdsState -> org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentStateOneOfMsg.newBuilder().setMdsState(map_org_somda_protosdc_biceps_model_MdsState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentStateOneOf.valueVmdState -> org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentStateOneOfMsg.newBuilder().setVmdState(map_org_somda_protosdc_biceps_model_VmdState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    ...
    fun map_org_somda_protosdc_biceps_model_ImagingProcedure(source: org.somda.protosdc.biceps.model.ImagingProcedure): org.somda.protosdc.proto.model.biceps.ImagingProcedureMsg {
        ...
        source.modality?.let { field ->
            builder.modality = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
        source.protocolCode?.let { field ->
            builder.protocolCode = map_org_somda_protosdc_biceps_model_CodedValue(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_OperationInvokedReport_ReportPart(source: org.somda.protosdc.biceps.model.OperationInvokedReport.ReportPart): org.somda.protosdc.proto.model.biceps.OperationInvokedReportMsg.ReportPartMsg {
        ...
        source.operationTargetAttr?.let { field ->
            builder.operationTargetAttr = map_org_somda_protosdc_biceps_model_HandleRef(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptor_ProductionSpecification(source: org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptor.ProductionSpecification): org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorMsg.ProductionSpecificationMsg {
        ...
        source.componentId?.let { field ->
            builder.componentId = map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractContextState(source: org.somda.protosdc.biceps.model.AbstractContextState): org.somda.protosdc.proto.model.biceps.AbstractContextStateMsg {
        ...
        builder.addAllIdentification(source.identification.map { map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(it) }.toList())
        source.contextAssociationAttr?.let { field ->
            builder.contextAssociationAttr = map_org_somda_protosdc_biceps_model_ContextAssociation(field)
        }
        source.bindingMdibVersionAttr?.let { field ->
            builder.bindingMdibVersionAttr = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
        source.unbindingMdibVersionAttr?.let { field ->
            builder.unbindingMdibVersionAttr = map_org_somda_protosdc_biceps_model_ReferencedVersion(field)
        }
        source.bindingStartTimeAttr?.let { field ->
            builder.bindingStartTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        source.bindingEndTimeAttr?.let { field ->
            builder.bindingEndTimeAttr = map_org_somda_protosdc_biceps_model_Timestamp(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractMetricDescriptor_Relation(source: org.somda.protosdc.biceps.model.AbstractMetricDescriptor.Relation): org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorMsg.RelationMsg {
        ...
        source.identification?.let { field ->
            builder.identification = map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractMetricDescriptor(source: org.somda.protosdc.biceps.model.AbstractMetricDescriptor): org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorMsg {
        ...
        source.derivationMethodAttr?.let { field ->
            builder.derivationMethodAttr = map_org_somda_protosdc_biceps_model_DerivationMethod(field)
        }
        builder.metricAvailabilityAttr = map_org_somda_protosdc_biceps_model_MetricAvailability(source.metricAvailabilityAttr)
        source.maxMeasurementTimeAttr?.let { field ->
            builder.maxMeasurementTimeAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.maxDelayTimeAttr?.let { field ->
            builder.maxDelayTimeAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.determinationPeriodAttr?.let { field ->
            builder.determinationPeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.lifeTimePeriodAttr?.let { field ->
            builder.lifeTimePeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        source.activationDurationAttr?.let { field ->
            builder.activationDurationAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_ClockDescriptor(source: org.somda.protosdc.biceps.model.ClockDescriptor): org.somda.protosdc.proto.model.biceps.ClockDescriptorMsg {
        ...
        source.resolutionAttr?.let { field ->
            builder.resolutionAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_NumericMetricDescriptor(source: org.somda.protosdc.biceps.model.NumericMetricDescriptor): org.somda.protosdc.proto.model.biceps.NumericMetricDescriptorMsg {
        ...
        builder.resolutionAttr = mapBigDecimalToProtoDecimal(source.resolutionAttr)
        source.averagingPeriodAttr?.let { field ->
            builder.averagingPeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_BatteryDescriptor(source: org.somda.protosdc.biceps.model.BatteryDescriptor): org.somda.protosdc.proto.model.biceps.BatteryDescriptorMsg {
        ...
        builder.abstractDeviceComponentDescriptor = map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptor(source.abstractDeviceComponentDescriptor)
        source.capacityFullCharge?.let { field ->
            builder.capacityFullCharge = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.capacitySpecified?.let { field ->
            builder.capacitySpecified = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.voltageSpecified?.let { field ->
            builder.voltageSpecified = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_LocationReference(source: org.somda.protosdc.biceps.model.LocationReference): org.somda.protosdc.proto.model.biceps.LocationReferenceMsg {
        ...
        builder.addAllIdentification(source.identification.map { map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(it) }.toList())
        source.locationDetail?.let { field ->
            builder.locationDetail = map_org_somda_protosdc_biceps_model_LocationDetail(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AlertSystemDescriptor(source: org.somda.protosdc.biceps.model.AlertSystemDescriptor): org.somda.protosdc.proto.model.biceps.AlertSystemDescriptorMsg {
        ...
        source.maxPhysiologicalParallelAlarmsAttr?.let { field ->
            builder.maxPhysiologicalParallelAlarmsAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt32(field)
        }
        source.maxTechnicalParallelAlarmsAttr?.let { field ->
            builder.maxTechnicalParallelAlarmsAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToUInt32(field)
        }
        source.selfCheckPeriodAttr?.let { field ->
            builder.selfCheckPeriodAttr = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapDuration(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_SystemContextDescriptor(source: org.somda.protosdc.biceps.model.SystemContextDescriptor): org.somda.protosdc.proto.model.biceps.SystemContextDescriptorMsg {
        ...
        builder.abstractDeviceComponentDescriptor = map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptor(source.abstractDeviceComponentDescriptor)
        source.patientContext?.let { field ->
            builder.patientContext = map_org_somda_protosdc_biceps_model_PatientContextDescriptor(field)
        }
        source.locationContext?.let { field ->
            builder.locationContext = map_org_somda_protosdc_biceps_model_LocationContextDescriptor(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentDescriptor(source: org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentDescriptor): org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentDescriptorMsg {
        ...
        builder.abstractDeviceComponentDescriptor = map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptor(source.abstractDeviceComponentDescriptor)
        source.alertSystem?.let { field ->
            builder.alertSystem = map_org_somda_protosdc_biceps_model_AlertSystemDescriptor(field)
        }
        source.sco?.let { field ->
            builder.sco = map_org_somda_protosdc_biceps_model_ScoDescriptor(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_EnumStringMetricDescriptor_AllowedValue(source: org.somda.protosdc.biceps.model.EnumStringMetricDescriptor.AllowedValue): org.somda.protosdc.proto.model.biceps.EnumStringMetricDescriptorMsg.AllowedValueMsg {
        ...
        source.characteristic?.let { field ->
            builder.characteristic = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractGetOneOf(source: org.somda.protosdc.biceps.model.AbstractGetOneOf): org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueAbstractGet -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setAbstractGet(map_org_somda_protosdc_biceps_model_AbstractGet(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetContainmentTree -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetContainmentTree(map_org_somda_protosdc_biceps_model_GetContainmentTree(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetContextStates -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetContextStates(map_org_somda_protosdc_biceps_model_GetContextStates(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetContextStatesByFilter -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetContextStatesByFilter(map_org_somda_protosdc_biceps_model_GetContextStatesByFilter(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetContextStatesByIdentification -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetContextStatesByIdentification(map_org_somda_protosdc_biceps_model_GetContextStatesByIdentification(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetDescriptor(map_org_somda_protosdc_biceps_model_GetDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetDescriptorsFromArchive -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetDescriptorsFromArchive(map_org_somda_protosdc_biceps_model_GetDescriptorsFromArchive(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetLocalizedText -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetLocalizedText(map_org_somda_protosdc_biceps_model_GetLocalizedText(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetMdDescription -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetMdDescription(map_org_somda_protosdc_biceps_model_GetMdDescription(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetMdState -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetMdState(map_org_somda_protosdc_biceps_model_GetMdState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetMdib -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetMdib(map_org_somda_protosdc_biceps_model_GetMdib(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetStatesFromArchive -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetStatesFromArchive(map_org_somda_protosdc_biceps_model_GetStatesFromArchive(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetOneOf.valueGetSupportedLanguages -> org.somda.protosdc.proto.model.biceps.AbstractGetOneOfMsg.newBuilder().setGetSupportedLanguages(map_org_somda_protosdc_biceps_model_GetSupportedLanguages(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractAlertReportOneOf(source: org.somda.protosdc.biceps.model.AbstractAlertReportOneOf): org.somda.protosdc.proto.model.biceps.AbstractAlertReportOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractAlertReportOneOf.valueAbstractAlertReport -> org.somda.protosdc.proto.model.biceps.AbstractAlertReportOneOfMsg.newBuilder().setAbstractAlertReport(map_org_somda_protosdc_biceps_model_AbstractAlertReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertReportOneOf.valueEpisodicAlertReport -> org.somda.protosdc.proto.model.biceps.AbstractAlertReportOneOfMsg.newBuilder().setEpisodicAlertReport(map_org_somda_protosdc_biceps_model_EpisodicAlertReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertReportOneOf.valuePeriodicAlertReport -> org.somda.protosdc.proto.model.biceps.AbstractAlertReportOneOfMsg.newBuilder().setPeriodicAlertReport(map_org_somda_protosdc_biceps_model_PeriodicAlertReport(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractOperationalStateReportOneOf(source: org.somda.protosdc.biceps.model.AbstractOperationalStateReportOneOf): org.somda.protosdc.proto.model.biceps.AbstractOperationalStateReportOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractOperationalStateReportOneOf.valueAbstractOperationalStateReport -> org.somda.protosdc.proto.model.biceps.AbstractOperationalStateReportOneOfMsg.newBuilder().setAbstractOperationalStateReport(map_org_somda_protosdc_biceps_model_AbstractOperationalStateReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationalStateReportOneOf.valueEpisodicOperationalStateReport -> org.somda.protosdc.proto.model.biceps.AbstractOperationalStateReportOneOfMsg.newBuilder().setEpisodicOperationalStateReport(map_org_somda_protosdc_biceps_model_EpisodicOperationalStateReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractOperationalStateReportOneOf.valuePeriodicOperationalStateReport -> org.somda.protosdc.proto.model.biceps.AbstractOperationalStateReportOneOfMsg.newBuilder().setPeriodicOperationalStateReport(map_org_somda_protosdc_biceps_model_PeriodicOperationalStateReport(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractMetricDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractMetricDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractMetricDescriptorOneOf.valueAbstractMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorOneOfMsg.newBuilder().setAbstractMetricDescriptor(map_org_somda_protosdc_biceps_model_AbstractMetricDescriptor(source.value)).build()
            ...
            org.somda.protosdc.biceps.model.AbstractMetricDescriptorOneOf.valueEnumStringMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorOneOfMsg.newBuilder().setEnumStringMetricDescriptor(map_org_somda_protosdc_biceps_model_EnumStringMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricDescriptorOneOf.valueNumericMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorOneOfMsg.newBuilder().setNumericMetricDescriptor(map_org_somda_protosdc_biceps_model_NumericMetricDescriptor(source.value)).build()
            ...
            org.somda.protosdc.biceps.model.AbstractMetricDescriptorOneOf.valueStringMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractMetricDescriptorOneOfMsg.newBuilder().setStringMetricDescriptor(map_org_somda_protosdc_biceps_model_StringMetricDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractAlertDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractAlertDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractAlertDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractAlertDescriptorOneOf.valueAbstractAlertDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractAlertDescriptorOneOfMsg.newBuilder().setAbstractAlertDescriptor(map_org_somda_protosdc_biceps_model_AbstractAlertDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertDescriptorOneOf.valueAlertConditionDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractAlertDescriptorOneOfMsg.newBuilder().setAlertConditionDescriptor(map_org_somda_protosdc_biceps_model_AlertConditionDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertDescriptorOneOf.valueAlertSignalDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractAlertDescriptorOneOfMsg.newBuilder().setAlertSignalDescriptor(map_org_somda_protosdc_biceps_model_AlertSignalDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertDescriptorOneOf.valueAlertSystemDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractAlertDescriptorOneOfMsg.newBuilder().setAlertSystemDescriptor(map_org_somda_protosdc_biceps_model_AlertSystemDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractAlertDescriptorOneOf.valueLimitAlertConditionDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractAlertDescriptorOneOfMsg.newBuilder().setLimitAlertConditionDescriptor(map_org_somda_protosdc_biceps_model_LimitAlertConditionDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractMetricReportOneOf(source: org.somda.protosdc.biceps.model.AbstractMetricReportOneOf): org.somda.protosdc.proto.model.biceps.AbstractMetricReportOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractMetricReportOneOf.valueAbstractMetricReport -> org.somda.protosdc.proto.model.biceps.AbstractMetricReportOneOfMsg.newBuilder().setAbstractMetricReport(map_org_somda_protosdc_biceps_model_AbstractMetricReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricReportOneOf.valueEpisodicMetricReport -> org.somda.protosdc.proto.model.biceps.AbstractMetricReportOneOfMsg.newBuilder().setEpisodicMetricReport(map_org_somda_protosdc_biceps_model_EpisodicMetricReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMetricReportOneOf.valuePeriodicMetricReport -> org.somda.protosdc.proto.model.biceps.AbstractMetricReportOneOfMsg.newBuilder().setPeriodicMetricReport(map_org_somda_protosdc_biceps_model_PeriodicMetricReport(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_StringMetricDescriptorOneOf(source: org.somda.protosdc.biceps.model.StringMetricDescriptorOneOf): org.somda.protosdc.proto.model.biceps.StringMetricDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.StringMetricDescriptorOneOf.valueStringMetricDescriptor -> org.somda.protosdc.proto.model.biceps.StringMetricDescriptorOneOfMsg.newBuilder().setStringMetricDescriptor(map_org_somda_protosdc_biceps_model_StringMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.StringMetricDescriptorOneOf.valueEnumStringMetricDescriptor -> org.somda.protosdc.proto.model.biceps.StringMetricDescriptorOneOfMsg.newBuilder().setEnumStringMetricDescriptor(map_org_somda_protosdc_biceps_model_EnumStringMetricDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractComponentReportOneOf(source: org.somda.protosdc.biceps.model.AbstractComponentReportOneOf): org.somda.protosdc.proto.model.biceps.AbstractComponentReportOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractComponentReportOneOf.valueAbstractComponentReport -> org.somda.protosdc.proto.model.biceps.AbstractComponentReportOneOfMsg.newBuilder().setAbstractComponentReport(map_org_somda_protosdc_biceps_model_AbstractComponentReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractComponentReportOneOf.valueEpisodicComponentReport -> org.somda.protosdc.proto.model.biceps.AbstractComponentReportOneOfMsg.newBuilder().setEpisodicComponentReport(map_org_somda_protosdc_biceps_model_EpisodicComponentReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractComponentReportOneOf.valuePeriodicComponentReport -> org.somda.protosdc.proto.model.biceps.AbstractComponentReportOneOfMsg.newBuilder().setPeriodicComponentReport(map_org_somda_protosdc_biceps_model_PeriodicComponentReport(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    ...
    fun map_org_somda_protosdc_biceps_model_VmdDescriptor(source: org.somda.protosdc.biceps.model.VmdDescriptor): org.somda.protosdc.proto.model.biceps.VmdDescriptorMsg {
        ...
        source.approvedJurisdictions?.let { field ->
            builder.approvedJurisdictions = map_org_somda_protosdc_biceps_model_ApprovedJurisdictions(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_MdsDescriptor_MetaData_Udi(source: org.somda.protosdc.biceps.model.MdsDescriptor.MetaData.Udi): org.somda.protosdc.proto.model.biceps.MdsDescriptorMsg.MetaDataMsg.UdiMsg {
        ...
        source.jurisdiction?.let { field ->
            builder.jurisdiction = map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_MdsDescriptor_MetaData(source: org.somda.protosdc.biceps.model.MdsDescriptor.MetaData): org.somda.protosdc.proto.model.biceps.MdsDescriptorMsg.MetaDataMsg {
        ...
        source.lotNumber?.let { field ->
            builder.lotNumber = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
        builder.addAllManufacturer(source.manufacturer.map { map_org_somda_protosdc_biceps_model_LocalizedText(it) }.toList())
        source.manufactureDate?.let { field ->
            builder.manufactureDate = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapLocalDateTimeOptional(field)
        }
        source.expirationDate?.let { field ->
            builder.expirationDate = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapLocalDateTimeOptional(field)
        }
        builder.addAllModelName(source.modelName.map { map_org_somda_protosdc_biceps_model_LocalizedText(it) }.toList())
        source.modelNumber?.let { field ->
            builder.modelNumber = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapToStringValue(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_MdsDescriptor(source: org.somda.protosdc.biceps.model.MdsDescriptor): org.somda.protosdc.proto.model.biceps.MdsDescriptorMsg {
        ...
        builder.abstractComplexDeviceComponentDescriptor = map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentDescriptor(source.abstractComplexDeviceComponentDescriptor)
        source.metaData?.let { field ->
            builder.metaData = map_org_somda_protosdc_biceps_model_MdsDescriptor_MetaData(field)
        }
        source.systemContext?.let { field ->
            builder.systemContext = map_org_somda_protosdc_biceps_model_SystemContextDescriptor(field)
        }
        source.clock?.let { field ->
            builder.clock = map_org_somda_protosdc_biceps_model_ClockDescriptor(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_MdDescription(source: org.somda.protosdc.biceps.model.MdDescription): org.somda.protosdc.proto.model.biceps.MdDescriptionMsg {
        ...
        source.descriptionVersionAttr?.let { field ->
            builder.descriptionVersionAttr = map_org_somda_protosdc_biceps_model_VersionCounter(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractDescriptor(map_org_somda_protosdc_biceps_model_AbstractDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractAlertDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractAlertDescriptor(map_org_somda_protosdc_biceps_model_AbstractAlertDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractComplexDeviceComponentDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractComplexDeviceComponentDescriptor(map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractContextDescriptor(map_org_somda_protosdc_biceps_model_AbstractContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractDeviceComponentDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractDeviceComponentDescriptor(map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractMetricDescriptor(map_org_somda_protosdc_biceps_model_AbstractMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractOperationDescriptor(map_org_somda_protosdc_biceps_model_AbstractOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAbstractSetStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAbstractSetStateOperationDescriptor(map_org_somda_protosdc_biceps_model_AbstractSetStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueActivateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setActivateOperationDescriptor(map_org_somda_protosdc_biceps_model_ActivateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAlertConditionDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAlertConditionDescriptor(map_org_somda_protosdc_biceps_model_AlertConditionDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAlertSignalDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAlertSignalDescriptor(map_org_somda_protosdc_biceps_model_AlertSignalDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueAlertSystemDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setAlertSystemDescriptor(map_org_somda_protosdc_biceps_model_AlertSystemDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueBatteryDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setBatteryDescriptor(map_org_somda_protosdc_biceps_model_BatteryDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueChannelDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setChannelDescriptor(map_org_somda_protosdc_biceps_model_ChannelDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueClockDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setClockDescriptor(map_org_somda_protosdc_biceps_model_ClockDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueDistributionSampleArrayMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setDistributionSampleArrayMetricDescriptor(map_org_somda_protosdc_biceps_model_DistributionSampleArrayMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueEnsembleContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setEnsembleContextDescriptor(map_org_somda_protosdc_biceps_model_EnsembleContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueEnumStringMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setEnumStringMetricDescriptor(map_org_somda_protosdc_biceps_model_EnumStringMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueLimitAlertConditionDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setLimitAlertConditionDescriptor(map_org_somda_protosdc_biceps_model_LimitAlertConditionDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueLocationContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setLocationContextDescriptor(map_org_somda_protosdc_biceps_model_LocationContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueMdsDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setMdsDescriptor(map_org_somda_protosdc_biceps_model_MdsDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueMeansContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setMeansContextDescriptor(map_org_somda_protosdc_biceps_model_MeansContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueNumericMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setNumericMetricDescriptor(map_org_somda_protosdc_biceps_model_NumericMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueOperatorContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setOperatorContextDescriptor(map_org_somda_protosdc_biceps_model_OperatorContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valuePatientContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setPatientContextDescriptor(map_org_somda_protosdc_biceps_model_PatientContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueRealTimeSampleArrayMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setRealTimeSampleArrayMetricDescriptor(map_org_somda_protosdc_biceps_model_RealTimeSampleArrayMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueScoDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setScoDescriptor(map_org_somda_protosdc_biceps_model_ScoDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSetAlertStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSetAlertStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetAlertStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSetComponentStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSetComponentStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetComponentStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSetContextStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSetContextStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetContextStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSetMetricStateOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSetMetricStateOperationDescriptor(map_org_somda_protosdc_biceps_model_SetMetricStateOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSetStringOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSetStringOperationDescriptor(map_org_somda_protosdc_biceps_model_SetStringOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSetValueOperationDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSetValueOperationDescriptor(map_org_somda_protosdc_biceps_model_SetValueOperationDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueStringMetricDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setStringMetricDescriptor(map_org_somda_protosdc_biceps_model_StringMetricDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueSystemContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setSystemContextDescriptor(map_org_somda_protosdc_biceps_model_SystemContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueVmdDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setVmdDescriptor(map_org_somda_protosdc_biceps_model_VmdDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDescriptorOneOf.valueWorkflowContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDescriptorOneOfMsg.newBuilder().setWorkflowContextDescriptor(map_org_somda_protosdc_biceps_model_WorkflowContextDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueAbstractDeviceComponentDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setAbstractDeviceComponentDescriptor(map_org_somda_protosdc_biceps_model_AbstractDeviceComponentDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueAbstractComplexDeviceComponentDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setAbstractComplexDeviceComponentDescriptor(map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueBatteryDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setBatteryDescriptor(map_org_somda_protosdc_biceps_model_BatteryDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueChannelDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setChannelDescriptor(map_org_somda_protosdc_biceps_model_ChannelDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueClockDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setClockDescriptor(map_org_somda_protosdc_biceps_model_ClockDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueMdsDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setMdsDescriptor(map_org_somda_protosdc_biceps_model_MdsDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueScoDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setScoDescriptor(map_org_somda_protosdc_biceps_model_ScoDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueSystemContextDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setSystemContextDescriptor(map_org_somda_protosdc_biceps_model_SystemContextDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractDeviceComponentDescriptorOneOf.valueVmdDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractDeviceComponentDescriptorOneOfMsg.newBuilder().setVmdDescriptor(map_org_somda_protosdc_biceps_model_VmdDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentDescriptorOneOf(source: org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentDescriptorOneOf): org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentDescriptorOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentDescriptorOneOf.valueAbstractComplexDeviceComponentDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentDescriptorOneOfMsg.newBuilder().setAbstractComplexDeviceComponentDescriptor(map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentDescriptorOneOf.valueMdsDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentDescriptorOneOfMsg.newBuilder().setMdsDescriptor(map_org_somda_protosdc_biceps_model_MdsDescriptor(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractComplexDeviceComponentDescriptorOneOf.valueVmdDescriptor -> org.somda.protosdc.proto.model.biceps.AbstractComplexDeviceComponentDescriptorOneOfMsg.newBuilder().setVmdDescriptor(map_org_somda_protosdc_biceps_model_VmdDescriptor(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    ...
    fun map_org_somda_protosdc_biceps_model_PersonReference(source: org.somda.protosdc.biceps.model.PersonReference): org.somda.protosdc.proto.model.biceps.PersonReferenceMsg {
        ...
        builder.addAllIdentification(source.identification.map { map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(it) }.toList())
        source.name?.let { field ->
            builder.name = map_org_somda_protosdc_biceps_model_BaseDemographicsOneOf(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_OrderDetail(source: org.somda.protosdc.biceps.model.OrderDetail): org.somda.protosdc.proto.model.biceps.OrderDetailMsg {
        ...
        source.start?.let { field ->
            builder.start = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapLocalDateTimeOptional(field)
        }
        source.end?.let { field ->
            builder.end = org.somda.sdc.protosdc.mapping.base.KotlinToProtoBaseTypes.mapLocalDateTimeOptional(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_OperatorContextState(source: org.somda.protosdc.biceps.model.OperatorContextState): org.somda.protosdc.proto.model.biceps.OperatorContextStateMsg {
        ...
        builder.abstractContextState = map_org_somda_protosdc_biceps_model_AbstractContextState(source.abstractContextState)
        source.operatorDetails?.let { field ->
            builder.operatorDetails = map_org_somda_protosdc_biceps_model_BaseDemographicsOneOf(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_PersonReferenceOneOf(source: org.somda.protosdc.biceps.model.PersonReferenceOneOf): org.somda.protosdc.proto.model.biceps.PersonReferenceOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.PersonReferenceOneOf.valuePersonReference -> org.somda.protosdc.proto.model.biceps.PersonReferenceOneOfMsg.newBuilder().setPersonReference(map_org_somda_protosdc_biceps_model_PersonReference(source.value)).build()
            org.somda.protosdc.biceps.model.PersonReferenceOneOf.valuePersonParticipation -> org.somda.protosdc.proto.model.biceps.PersonReferenceOneOfMsg.newBuilder().setPersonParticipation(map_org_somda_protosdc_biceps_model_PersonParticipation(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_NeonatalPatientDemographicsCoreData(source: org.somda.protosdc.biceps.model.NeonatalPatientDemographicsCoreData): org.somda.protosdc.proto.model.biceps.NeonatalPatientDemographicsCoreDataMsg {
        ...
        source.gestationalAge?.let { field ->
            builder.gestationalAge = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.birthLength?.let { field ->
            builder.birthLength = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.birthWeight?.let { field ->
            builder.birthWeight = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.headCircumference?.let { field ->
            builder.headCircumference = map_org_somda_protosdc_biceps_model_Measurement(field)
        }
        source.mother?.let { field ->
            builder.mother = map_org_somda_protosdc_biceps_model_PersonReferenceOneOf(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_WorkflowContextState_WorkflowDetail_RequestedOrderDetail(source: org.somda.protosdc.biceps.model.WorkflowContextState.WorkflowDetail.RequestedOrderDetail): org.somda.protosdc.proto.model.biceps.WorkflowContextStateMsg.WorkflowDetailMsg.RequestedOrderDetailMsg {
        ...
        source.referringPhysician?.let { field ->
            builder.referringPhysician = map_org_somda_protosdc_biceps_model_PersonReferenceOneOf(field)
        }
        source.requestingPhysician?.let { field ->
            builder.requestingPhysician = map_org_somda_protosdc_biceps_model_PersonReferenceOneOf(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_WorkflowContextState_WorkflowDetail_PerformedOrderDetail(source: org.somda.protosdc.biceps.model.WorkflowContextState.WorkflowDetail.PerformedOrderDetail): org.somda.protosdc.proto.model.biceps.WorkflowContextStateMsg.WorkflowDetailMsg.PerformedOrderDetailMsg {
        ...
        builder.orderDetail = map_org_somda_protosdc_biceps_model_OrderDetail(source.orderDetail)
        source.fillerOrderNumber?.let { field ->
            builder.fillerOrderNumber = map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(field)
        }
    ...
    fun map_org_somda_protosdc_biceps_model_WorkflowContextState_WorkflowDetail(source: org.somda.protosdc.biceps.model.WorkflowContextState.WorkflowDetail): org.somda.protosdc.proto.model.biceps.WorkflowContextStateMsg.WorkflowDetailMsg {
        ...
        source.assignedLocation?.let { field ->
            builder.assignedLocation = map_org_somda_protosdc_biceps_model_LocationReference(field)
        }
        source.visitNumber?.let { field ->
            builder.visitNumber = map_org_somda_protosdc_biceps_model_InstanceIdentifierOneOf(field)
        }
        ...
        source.requestedOrderDetail?.let { field ->
            builder.requestedOrderDetail = map_org_somda_protosdc_biceps_model_WorkflowContextState_WorkflowDetail_RequestedOrderDetail(field)
        }
        source.performedOrderDetail?.let { field ->
            builder.performedOrderDetail = map_org_somda_protosdc_biceps_model_WorkflowContextState_WorkflowDetail_PerformedOrderDetail(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_WorkflowContextState(source: org.somda.protosdc.biceps.model.WorkflowContextState): org.somda.protosdc.proto.model.biceps.WorkflowContextStateMsg {
        ...
        builder.abstractContextState = map_org_somda_protosdc_biceps_model_AbstractContextState(source.abstractContextState)
        source.workflowDetail?.let { field ->
            builder.workflowDetail = map_org_somda_protosdc_biceps_model_WorkflowContextState_WorkflowDetail(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_PatientDemographicsCoreDataOneOf(source: org.somda.protosdc.biceps.model.PatientDemographicsCoreDataOneOf): org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.PatientDemographicsCoreDataOneOf.valuePatientDemographicsCoreData -> org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataOneOfMsg.newBuilder().setPatientDemographicsCoreData(map_org_somda_protosdc_biceps_model_PatientDemographicsCoreData(source.value)).build()
            org.somda.protosdc.biceps.model.PatientDemographicsCoreDataOneOf.valueNeonatalPatientDemographicsCoreData -> org.somda.protosdc.proto.model.biceps.PatientDemographicsCoreDataOneOfMsg.newBuilder().setNeonatalPatientDemographicsCoreData(map_org_somda_protosdc_biceps_model_NeonatalPatientDemographicsCoreData(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_PatientContextState(source: org.somda.protosdc.biceps.model.PatientContextState): org.somda.protosdc.proto.model.biceps.PatientContextStateMsg {
        ...
        builder.abstractContextState = map_org_somda_protosdc_biceps_model_AbstractContextState(source.abstractContextState)
        source.coreData?.let { field ->
            builder.coreData = map_org_somda_protosdc_biceps_model_PatientDemographicsCoreDataOneOf(field)
        }
        return builder.build()
    }
    fun map_org_somda_protosdc_biceps_model_AbstractStateOneOf(source: org.somda.protosdc.biceps.model.AbstractStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractState(map_org_somda_protosdc_biceps_model_AbstractState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractAlertState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractAlertState(map_org_somda_protosdc_biceps_model_AbstractAlertState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractComplexDeviceComponentState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractComplexDeviceComponentState(map_org_somda_protosdc_biceps_model_AbstractComplexDeviceComponentState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractContextState(map_org_somda_protosdc_biceps_model_AbstractContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractDeviceComponentState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractDeviceComponentState(map_org_somda_protosdc_biceps_model_AbstractDeviceComponentState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractMetricState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractMetricState(map_org_somda_protosdc_biceps_model_AbstractMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractMultiState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractMultiState(map_org_somda_protosdc_biceps_model_AbstractMultiState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAbstractOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAbstractOperationState(map_org_somda_protosdc_biceps_model_AbstractOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueActivateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setActivateOperationState(map_org_somda_protosdc_biceps_model_ActivateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAlertConditionState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAlertConditionState(map_org_somda_protosdc_biceps_model_AlertConditionState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAlertSignalState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAlertSignalState(map_org_somda_protosdc_biceps_model_AlertSignalState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueAlertSystemState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setAlertSystemState(map_org_somda_protosdc_biceps_model_AlertSystemState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueBatteryState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setBatteryState(map_org_somda_protosdc_biceps_model_BatteryState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueChannelState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setChannelState(map_org_somda_protosdc_biceps_model_ChannelState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueClockState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setClockState(map_org_somda_protosdc_biceps_model_ClockState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueDistributionSampleArrayMetricState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setDistributionSampleArrayMetricState(map_org_somda_protosdc_biceps_model_DistributionSampleArrayMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueEnsembleContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setEnsembleContextState(map_org_somda_protosdc_biceps_model_EnsembleContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueEnumStringMetricState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setEnumStringMetricState(map_org_somda_protosdc_biceps_model_EnumStringMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueLimitAlertConditionState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setLimitAlertConditionState(map_org_somda_protosdc_biceps_model_LimitAlertConditionState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueLocationContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setLocationContextState(map_org_somda_protosdc_biceps_model_LocationContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueMdsState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setMdsState(map_org_somda_protosdc_biceps_model_MdsState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueMeansContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setMeansContextState(map_org_somda_protosdc_biceps_model_MeansContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueNumericMetricState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setNumericMetricState(map_org_somda_protosdc_biceps_model_NumericMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueOperatorContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setOperatorContextState(map_org_somda_protosdc_biceps_model_OperatorContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valuePatientContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setPatientContextState(map_org_somda_protosdc_biceps_model_PatientContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueRealTimeSampleArrayMetricState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setRealTimeSampleArrayMetricState(map_org_somda_protosdc_biceps_model_RealTimeSampleArrayMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueScoState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setScoState(map_org_somda_protosdc_biceps_model_ScoState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSetAlertStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSetAlertStateOperationState(map_org_somda_protosdc_biceps_model_SetAlertStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSetComponentStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSetComponentStateOperationState(map_org_somda_protosdc_biceps_model_SetComponentStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSetContextStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSetContextStateOperationState(map_org_somda_protosdc_biceps_model_SetContextStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSetMetricStateOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSetMetricStateOperationState(map_org_somda_protosdc_biceps_model_SetMetricStateOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSetStringOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSetStringOperationState(map_org_somda_protosdc_biceps_model_SetStringOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSetValueOperationState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSetValueOperationState(map_org_somda_protosdc_biceps_model_SetValueOperationState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueStringMetricState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setStringMetricState(map_org_somda_protosdc_biceps_model_StringMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueSystemContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setSystemContextState(map_org_somda_protosdc_biceps_model_SystemContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueVmdState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setVmdState(map_org_somda_protosdc_biceps_model_VmdState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractStateOneOf.valueWorkflowContextState -> org.somda.protosdc.proto.model.biceps.AbstractStateOneOfMsg.newBuilder().setWorkflowContextState(map_org_somda_protosdc_biceps_model_WorkflowContextState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractMultiStateOneOf(source: org.somda.protosdc.biceps.model.AbstractMultiStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueAbstractMultiState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setAbstractMultiState(map_org_somda_protosdc_biceps_model_AbstractMultiState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueAbstractContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setAbstractContextState(map_org_somda_protosdc_biceps_model_AbstractContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueEnsembleContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setEnsembleContextState(map_org_somda_protosdc_biceps_model_EnsembleContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueLocationContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setLocationContextState(map_org_somda_protosdc_biceps_model_LocationContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueMeansContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setMeansContextState(map_org_somda_protosdc_biceps_model_MeansContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueOperatorContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setOperatorContextState(map_org_somda_protosdc_biceps_model_OperatorContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valuePatientContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setPatientContextState(map_org_somda_protosdc_biceps_model_PatientContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractMultiStateOneOf.valueWorkflowContextState -> org.somda.protosdc.proto.model.biceps.AbstractMultiStateOneOfMsg.newBuilder().setWorkflowContextState(map_org_somda_protosdc_biceps_model_WorkflowContextState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractContextStateOneOf(source: org.somda.protosdc.biceps.model.AbstractContextStateOneOf): org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valueAbstractContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setAbstractContextState(map_org_somda_protosdc_biceps_model_AbstractContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valueEnsembleContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setEnsembleContextState(map_org_somda_protosdc_biceps_model_EnsembleContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valueLocationContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setLocationContextState(map_org_somda_protosdc_biceps_model_LocationContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valueMeansContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setMeansContextState(map_org_somda_protosdc_biceps_model_MeansContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valueOperatorContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setOperatorContextState(map_org_somda_protosdc_biceps_model_OperatorContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valuePatientContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setPatientContextState(map_org_somda_protosdc_biceps_model_PatientContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextStateOneOf.valueWorkflowContextState -> org.somda.protosdc.proto.model.biceps.AbstractContextStateOneOfMsg.newBuilder().setWorkflowContextState(map_org_somda_protosdc_biceps_model_WorkflowContextState(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    ...
    fun map_org_somda_protosdc_biceps_model_DescriptionModificationReport_ReportPart(source: org.somda.protosdc.biceps.model.DescriptionModificationReport.ReportPart): org.somda.protosdc.proto.model.biceps.DescriptionModificationReportMsg.ReportPartMsg {
        ...
        builder.addAllPDescriptor(source.descriptor.map { map_org_somda_protosdc_biceps_model_AbstractDescriptorOneOf(it) }.toList())
        builder.addAllState(source.state.map { map_org_somda_protosdc_biceps_model_AbstractStateOneOf(it) }.toList())
        source.parentDescriptorAttr?.let { field ->
            builder.parentDescriptorAttr = map_org_somda_protosdc_biceps_model_HandleRef(field)
        }
        source.modificationTypeAttr?.let { field ->
            builder.modificationTypeAttr = map_org_somda_protosdc_biceps_model_DescriptionModificationType(field)
        }
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_Mdib(source: org.somda.protosdc.biceps.model.Mdib): org.somda.protosdc.proto.model.biceps.MdibMsg {
        ...
        source.mdDescription?.let { field ->
            builder.mdDescription = map_org_somda_protosdc_biceps_model_MdDescription(field)
        }
        source.mdState?.let { field ->
            builder.mdState = map_org_somda_protosdc_biceps_model_MdState(field)
        }
        builder.mdibVersionGroupAttr = map_org_somda_protosdc_biceps_model_MdibVersionGroup(source.mdibVersionGroupAttr)
        return builder.build()
    }
    ...
    fun map_org_somda_protosdc_biceps_model_AbstractGetResponseOneOf(source: org.somda.protosdc.biceps.model.AbstractGetResponseOneOf): org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueAbstractGetResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setAbstractGetResponse(map_org_somda_protosdc_biceps_model_AbstractGetResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetContainmentTreeResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetContainmentTreeResponse(map_org_somda_protosdc_biceps_model_GetContainmentTreeResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetContextStatesByFilterResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetContextStatesByFilterResponse(map_org_somda_protosdc_biceps_model_GetContextStatesByFilterResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetContextStatesByIdentificationResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetContextStatesByIdentificationResponse(map_org_somda_protosdc_biceps_model_GetContextStatesByIdentificationResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetContextStatesResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetContextStatesResponse(map_org_somda_protosdc_biceps_model_GetContextStatesResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetDescriptorResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetDescriptorResponse(map_org_somda_protosdc_biceps_model_GetDescriptorResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetDescriptorsFromArchiveResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetDescriptorsFromArchiveResponse(map_org_somda_protosdc_biceps_model_GetDescriptorsFromArchiveResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetLocalizedTextResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetLocalizedTextResponse(map_org_somda_protosdc_biceps_model_GetLocalizedTextResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetMdDescriptionResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetMdDescriptionResponse(map_org_somda_protosdc_biceps_model_GetMdDescriptionResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetMdStateResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetMdStateResponse(map_org_somda_protosdc_biceps_model_GetMdStateResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetMdibResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetMdibResponse(map_org_somda_protosdc_biceps_model_GetMdibResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetStatesFromArchiveResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetStatesFromArchiveResponse(map_org_somda_protosdc_biceps_model_GetStatesFromArchiveResponse(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractGetResponseOneOf.valueGetSupportedLanguagesResponse -> org.somda.protosdc.proto.model.biceps.AbstractGetResponseOneOfMsg.newBuilder().setGetSupportedLanguagesResponse(map_org_somda_protosdc_biceps_model_GetSupportedLanguagesResponse(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractSetOneOf(source: org.somda.protosdc.biceps.model.AbstractSetOneOf): org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueAbstractSet -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setAbstractSet(map_org_somda_protosdc_biceps_model_AbstractSet(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueActivate -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setActivate(map_org_somda_protosdc_biceps_model_Activate(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueSetAlertState -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setSetAlertState(map_org_somda_protosdc_biceps_model_SetAlertState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueSetComponentState -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setSetComponentState(map_org_somda_protosdc_biceps_model_SetComponentState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueSetContextState -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setSetContextState(map_org_somda_protosdc_biceps_model_SetContextState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueSetMetricState -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setSetMetricState(map_org_somda_protosdc_biceps_model_SetMetricState(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueSetString -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setSetString(map_org_somda_protosdc_biceps_model_SetString(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractSetOneOf.valueSetValue -> org.somda.protosdc.proto.model.biceps.AbstractSetOneOfMsg.newBuilder().setSetValue(map_org_somda_protosdc_biceps_model_SetValue(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractReportOneOf(source: org.somda.protosdc.biceps.model.AbstractReportOneOf): org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueAbstractReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setAbstractReport(map_org_somda_protosdc_biceps_model_AbstractReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueAbstractAlertReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setAbstractAlertReport(map_org_somda_protosdc_biceps_model_AbstractAlertReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueAbstractComponentReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setAbstractComponentReport(map_org_somda_protosdc_biceps_model_AbstractComponentReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueAbstractContextReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setAbstractContextReport(map_org_somda_protosdc_biceps_model_AbstractContextReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueAbstractMetricReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setAbstractMetricReport(map_org_somda_protosdc_biceps_model_AbstractMetricReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueAbstractOperationalStateReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setAbstractOperationalStateReport(map_org_somda_protosdc_biceps_model_AbstractOperationalStateReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueDescriptionModificationReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setDescriptionModificationReport(map_org_somda_protosdc_biceps_model_DescriptionModificationReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueEpisodicAlertReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setEpisodicAlertReport(map_org_somda_protosdc_biceps_model_EpisodicAlertReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueEpisodicComponentReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setEpisodicComponentReport(map_org_somda_protosdc_biceps_model_EpisodicComponentReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueEpisodicContextReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setEpisodicContextReport(map_org_somda_protosdc_biceps_model_EpisodicContextReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueEpisodicMetricReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setEpisodicMetricReport(map_org_somda_protosdc_biceps_model_EpisodicMetricReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueEpisodicOperationalStateReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setEpisodicOperationalStateReport(map_org_somda_protosdc_biceps_model_EpisodicOperationalStateReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueObservedValueStream -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setObservedValueStream(map_org_somda_protosdc_biceps_model_ObservedValueStream(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueOperationInvokedReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setOperationInvokedReport(map_org_somda_protosdc_biceps_model_OperationInvokedReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valuePeriodicAlertReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setPeriodicAlertReport(map_org_somda_protosdc_biceps_model_PeriodicAlertReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valuePeriodicComponentReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setPeriodicComponentReport(map_org_somda_protosdc_biceps_model_PeriodicComponentReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valuePeriodicContextReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setPeriodicContextReport(map_org_somda_protosdc_biceps_model_PeriodicContextReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valuePeriodicMetricReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setPeriodicMetricReport(map_org_somda_protosdc_biceps_model_PeriodicMetricReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valuePeriodicOperationalStateReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setPeriodicOperationalStateReport(map_org_somda_protosdc_biceps_model_PeriodicOperationalStateReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueSystemErrorReport -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setSystemErrorReport(map_org_somda_protosdc_biceps_model_SystemErrorReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractReportOneOf.valueWaveformStream -> org.somda.protosdc.proto.model.biceps.AbstractReportOneOfMsg.newBuilder().setWaveformStream(map_org_somda_protosdc_biceps_model_WaveformStream(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
    fun map_org_somda_protosdc_biceps_model_AbstractContextReportOneOf(source: org.somda.protosdc.biceps.model.AbstractContextReportOneOf): org.somda.protosdc.proto.model.biceps.AbstractContextReportOneOfMsg {
        when (source) {
            org.somda.protosdc.biceps.model.AbstractContextReportOneOf.valueAbstractContextReport -> org.somda.protosdc.proto.model.biceps.AbstractContextReportOneOfMsg.newBuilder().setAbstractContextReport(map_org_somda_protosdc_biceps_model_AbstractContextReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextReportOneOf.valueEpisodicContextReport -> org.somda.protosdc.proto.model.biceps.AbstractContextReportOneOfMsg.newBuilder().setEpisodicContextReport(map_org_somda_protosdc_biceps_model_EpisodicContextReport(source.value)).build()
            org.somda.protosdc.biceps.model.AbstractContextReportOneOf.valuePeriodicContextReport -> org.somda.protosdc.proto.model.biceps.AbstractContextReportOneOfMsg.newBuilder().setPeriodicContextReport(map_org_somda_protosdc_biceps_model_PeriodicContextReport(source.value)).build()
            else -> throw Exception("Unknown enum value $source")
        }
    }
}
